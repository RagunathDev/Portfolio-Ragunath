...
import { github, linkedin, ins} from '../assets';
const Navbar = () => {
...
<div className="w-full flex justify-between items-center max-w-7xl mx-auto">
    ...
    <ul className="list-none hidden sm:flex flex-row gap-14 mt-2">
        ...
        <div className="absolute inset-2.5 flex justify-end right-20">
            <div onClick={() => window.open('https://www.instagram.com/_ragunath_tr/?igsh=OTdycGQ2enhhMjUw', '_blank')} className="bg-night sm:w-9 sm:h-9 w-11 h-11 rounded-full flex justify-center items-center cursor-pointer sm:opacity-[0.9] opacity-[0.8]">
                <img
                    src={ins}
                    alt="source code"
                    className="w-3/3 h-4/5 object-contain rounded-full"
        ...
        <div className="absolute inset-3 justify-end right-40  flex">
    ...
    <div className="sm:hidden flex flex-1 w-screen justify-end items-center">
        ...
        <ul
            ...
            <div className="absolute inset-3 justify-end right-60 mt-2 flex">
            ...
            <div className="absolute inset-3  mt-2 flex justify-end right-20">
            <div onClick={() => window.open('https://www.instagram.com/_ragunath_tr/?igsh=OTdycGQ2enhhMjUw', '_blank')} className="bg-night sm:w-9 sm:h-9 w-9 h-9 rounded-full flex justify-center items-center cursor-pointer sm:opacity-[0.9] opacity-[0.8]">
                <img
                    src={ins}
                    alt="source code"
                    className="w-3/3 h-4/5 object-contain rounded-full"
